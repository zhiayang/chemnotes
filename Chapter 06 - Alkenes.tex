...
\subsection{Stability of Carbocations}
	...
	\subsubsection{Structure}
		...
		\diagram{
			\chemfig{\chemabove{C}{\smfplus}(<[:315,,1]!{R1})(<:[:45,,1]!{R2})(-[:180]!{R})}
		}
...
\subsection{Electrophilic Addition}
	...
	\subsubsection{Addition of \ch{H-X} to Unsymmetrical Alkenes}
		...
		\diagram[0.85]{
			...
			\arrow{->[slow]}
			\chemfig{\smfplus|C(-[:90,,2]H)(-[:270,,2]H)-C(-[:90]H)(-[:270]H)-!{CH3}}
			\hspace{5mm} + \hspace{5mm}
			\chemfig{!{Br}\mch}
			\schemestop
		...
		\diagram[0.85]{
			...
			\chemfig{@{hyd}\chembelow{H}{\smdeltap}-[@{b2}:0]@{hal}\chembelow{{\color{Mahogany}Br}}{\smdeltam}}
			\arrow{->[slow]}
			\chemfig{!{H3C}-\chemabove{C}{\smfplus}(-[:270]H)-!{CH3}}
			\hspace{5mm} + \hspace{5mm}
			\chemfig{!{Br}\mch}
			\schemestop
	...
	\subsubsection{Electrophilic Addition of Aqueous \ch{Br2}}
		...
		\diagram[0.825]{
			...
			\arrow{->[fast]}
			\chemfig{C(-[:180]H)(-[:90]H)(-[:270]!{OH})-C(-[:90]H)(-[:0]H)(-[:270]!{Br})}
			\hspace{5mm} + \hspace{5mm}
			\chemfig{H-!{Br}}
			\schemestop
		...
		\diagram[0.80]{
			...
			\chemfig{C(-[:135]H)(-[:225]H)=[@{b1}:0]C(-[:45]H)(-[:315]H)}
			\hspace{5mm} + \hspace{5mm}
			\chemname{\chemfig{!{Br}-!{Br}}}{(aq)}
			\arrow
			\chemname{\chemfig{C(-[:180]H)(-[:90]H)(-[:270]!{OH})-C(-[:90]H)(-[:0]H)(-[:270]!{Br})}}{(major)}
			\hspace{5mm} + \hspace{5mm}
			\chemname{\chemfig{C(-[:180]H)(-[:90]H)(-[:270]!{Br})-C(-[:90]H)(-[:0]H)(-[:270]!{Br})}}{(minor)}
			\schemestop
	...
	\subsubsection{Electrophilic Addition of Steam (Hydration)}
		...
		\diagram{
			...
			\chemfig{H\pch}
			\arrow
			\chemfig{!{O}|\pch(-[:315,,1]H)(-[:225]H)(-[:90]H)}
			\schemestop

			\chemmove{\draw[-Stealth,line width=0.4mm,shorten <=2mm,shorten >=1mm](oxy) .. controls +(45:8mm) and +(135:8mm) .. (plus);}
		}
		...
		\diagram[0.8]{
			...
			\hspace{5mm} + \hspace{5mm}
			\chemfig{C(-[:135]H)(-[:225]!{H3C})=[@{db}:0]C(-[:45]H)(-[:315]H)}
			\arrow
			\chemfig{\chemabove{C}{\smfplus}(-[:270]!{CH3})(-[:180]H)-C(-[:270]H)(-[:90]H)(-[:0]H)}
			\hspace{5mm} + \hspace{5mm}
			\chemfig{\water}
			\schemestop
		...
		\diagram{
			...
			\hspace{5mm} + \hspace{5mm}
			\chemfig{@{carb}\chemabove{C}{\smfplus}(-[:270]!{CH3})(-[:180]H)-C(-[:270]H)(-[:90]H)(-[:0]H)}
			\arrow
			\chemfig{C(-[:90]\lewis{2:,\color{Red}O}|\pch(-[:150]H)(-[:210]H))(-[:270]!{CH3})(-[:180]H)-C(-[:270]H)(-[:90]H)(-[:0]H)}
			\schemestop
		...
		\diagram[0.8]{
			\schemestart[0, 1.5, thick]
			\chemfig{C(-[:90]@{o1}\lewis{2:,\color{Red}O}|\pch(-[@{bond}:150]@{hyd}H)(-[:210]H))(-[:270]!{CH3})(-[:180]H)-C(-[:270]H)(-[:90]H)(-[:0]H)}
			\hspace{5mm} + \hspace{5mm}
			\chemfig{@{o2}\lewis{3:5:,\color{Red}O}(-[:52]H)(-[:308]H)}
			\arrow
			\chemfig{C(-[:270]!{CH3})(-[:180]H)(-[:90]!{OH})-C(-[:90]H)(-[:0]H)(-[:270]H)}
			\hspace{5mm} + \hspace{5mm}
...
\subsection{Mild Oxidation of Alkenes}
	...
	\vbox{\textbf{Observations:}\tabto{35mm}{\color{Plum}Purple} \ch{KMnO4} decolourises.}
	...
	\diagram[0.9]{
		...
		\chemfig{C(-[:270]!{OH})(-[:180]H)(-[:90]H)-C(-[:90]H)(-[:0]H)(-[:270]!{OH})}
		\schemestop
	}
	...
	\vbox{\textbf{Observations:}\tabto{35mm}{\color{Plum}Purple} \ch{KMnO4} decolourises, forming
		a {\color{Brown}brown} precipitate of \ch{MnO2}}
...
\subsection{Oxidative Cleavage (Strong Oxidation) of Alkenes}
	...
	\begin{tabu} to \textwidth {| X[c,m] | X[c,m] | X[c,m] |}
		...
		Substituents	&		Structure												&	Product			\\		\hline
			...
			1
						...
						&		\vspace{2mm}\chemfig{C(-[:135]!{HO})(-[:225]!{R})=[:0]!{O}}	\vspace{2mm}	\\		\hline

			2
						&		\vspace{2mm}\chemfig{C(-[:135]!{R})(-[:225]!{R})=[:0]}		\vspace{2mm}
						&		\vspace{2mm}\chemfig{C(-[:135]!{R})(-[:225]!{R})=[:0]!{O}}	\vspace{2mm}	\\		\hline
	...
	\subsubsection{Further Oxidation of Ethanedioic Acid}
		...
		\diagram[1.0]{
			\schemestart[0, 1.5, thick]
			\chemfig{C(-[:135]!{HO})(=[:225]!{O})-C(=[:45]!{O})(-[:315]!{OH})}
			\arrow
