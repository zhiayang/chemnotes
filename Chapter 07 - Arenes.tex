...
\subsection{Nitration of Benzene}
	...
	\subsection{Substituted Benzenes}
		...
		\vspace{2.0em}
		\subsubtext{Halogen Substituents}
	...
	\subsection{Alkylbenzene Reactions}
		...
		\subsubsection{Side-chain Oxidation}
			...
			\vbox{\textbf{Observations:}\tabto{35mm}\textit{\color{Plum}Purple} \ch{KMnO4} decolourises (\textit{acid}), or
										\tabto{35mm}\textit{\color{Brown}Brown} precipitate of \ch{MnO2} (\textit{alkali}).}
			...
			\pagebreak
			Alternatively, an alkali medium can be used, for instance with \ch{NaOH \aq{}}. Instead of forming benzoic acid however, the
