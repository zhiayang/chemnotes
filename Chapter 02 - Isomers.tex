...
\subsection{Structural Isomerism}
	...
	\subsubsection{Chain Isomerism}
		...
		\diagram[1.1]{
			\chemfig{!{H3C}-[:30]-[:-30]-[:30]-[:-30]-[:30]!{OH}}\hspace{10mm}
	...
	\subsubsection{Positional Isomerism}
		...
		\diagram[1.1]{
			\chemfig{!{H3C}-[:-30](-[:270]!{OH})-[:30](-[:90]!{OH})-[:-30]-[:30]!{CH3}}\hspace{10mm}
	...
	\subsubsection{Functional Group Isomerism}
		...
		\diagram[1.1]{
			...
			\chemfig{!{O}=^[:90]-[:150]-[:210]!{H3C}}			\hspace{10mm}
...
\subsection{Stereoisomerism}
	...
	\subsubsection{Cis/Trans Isomerism}
		...
		Only alkenes can exhibit stereoisomerism, due to the \ch{C=C} bond that restricts rotation along its axis. This is because of the
		π-bonds that only bond at 180° intervals. At these positions, it forms the cis and trans isomers.

		\diagram[1.2]{
			\chemfig{C(-[:135]H)(-[:225]R1)=C(-[:45]R2)(-[:315]H)}		\hspace{15mm}
	...
	\subsubsection{E/Z Isomerism}
		...
		\diagram[1.2]{
			\chemfig{C(-[:135]!{Cl})(-[:225]!{F})=C(-[:45]!{CH3})(-[:315]!{Br})}		\hspace{15mm}
	...
	\subsubsection{Optical Isomerism}
		...
		\diagram[1.2]{
			\chemfig{C(-[:225]H)(-[:90]!{CH2CH3})(<:[:315]!{OH})(<[:350]!{CH3})}		\hspace{7.5mm}\vdashrule{30mm}\hspace{7.5mm}
