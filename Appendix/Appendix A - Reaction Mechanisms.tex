...
\part{Reaction Mechanisms}
	...
	\section{Electrophilic Addition}
		...
		\subsection{Markovnikov's Rule}
			...
			existing hydrogen atoms. Note that \itl{X} can be a halogen, a hydroxide (ie. \ch{H-X} is \ch{H2O}) or some other
			...
			\subsubsection{Addition of \ch{H-X} to Unsymmetrical Alkenes}
				...
				If the Markovnikov's rule is \itl{not} followed, the following will take place:
				...
				As such, it is more likely to form, and hence 2-bromopropane will be the \itl{major product}, and
				1-bromopropane will be the \itl{minor product}.
		...
		\subsection{Electrophilic Addition of HX}
			...
			This is the rate-determining step, which involves breaking the $\pi$-bond. The polar \ch{HX} molecule has to
			...
			}{The electron pair arrow points to the plus charge on the carbon, \itl{not} the carbon atom itself.}
		...
		\subsection{Electrophilic Addition of \ch{X2}}
			...
			\deltap{} and \deltam{} partial charges. The reaction mechanism involves the formation of a \itl{cyclic halonium ion} --- the
	...
	\section{Electrophilic Substitution}
		...
		Two electrons out of six from the delocalised $\pi$-system are used to form the bond between the electrophile, E, and the carbon.
		Thus, there is a positive charge on the carbon; due to the delocalised nature of the $\pi$-system however, this positive charge is
		delocalised across \itl{all 6 carbons}, making it much more stable than a simple carbocation.
		...
		bond are returned to the $\pi$-system.
		...
		results in a \itl{temporary} disruption of the planar structure of benzene.
		...
		\subsection{Nitration of Benzene}
			...
			Now that the electrophile \ch{NO2+} has been formed, it is attacked by the $\pi$-system. As with all electrophilic substitutions, this
			...
			restores both the $\pi$-system of the benzene ring, as well as the catalyst, \ch{H2SO4}.
		...
		\subsection{Halogenation of Benzene}
			...
			\subsubsection{Catalysts}
				...
				Lewis acid catalysts must be used, since the \ch{Br-Br} and \ch{\Cl-\Cl} molecules are only instantaneously
			...
			\subsubsection{Reaction Mechanism}
				...
				The reaction below uses Iron (III) chlorine (\ch{Fe\Cl3}) as an example, adding \ch{\Cl} to benzene,
				...
				\diagram{
					...
					\schemestop
				}{The catalyst is \ch{FeBr4-}, and the \itl{electrophile} is \ch{Br+}}
				...
				\paragraph{Restoration of $\pi$-system and Aromaticity}
	...
	\section{Nucleophilic Addition}
		...
		\subsection{Stereoisomerism of Product}
			...
			Hence, if the product formed is chiral, the resulting solution will be a \itl{racemic mixture}.
	...
	\section{Nucleophilic Substitution}
		...
		\itl{electron-deficient}, which makes it more susceptible to attacks from nucleophiles (\itl{electron-rich}), and
		...
		\subsection{Nucleophilic Substitution (\sntwo{}, single-step)}
			...
			\itl{one}-step reaction --- it is \sntwo{} because \itl{two} molecules are involved in the slow (only) step.
			...
			weakens the \ch{C-Br} bond, and it begins to break. At this stage, the \itl{transition state} is formed, which is an
			unstable, activated complex where bond-breaking and bond-forming occur simultaneously --- this is a \itl{one-step} mechanism.

			\subsubsection{Stereoisomerism of Product}

				Note that the chirality of the molecule will be \itl{inverted}, if it is chiral. Imagine the attacking nucleophile
		...
		\subsection{Nucleophilic Substitution (\snone{}, two-step)}
			...
			The \snone{} reaction is a \itl{two-step} reaction, because larger groups attached to the central carbon
