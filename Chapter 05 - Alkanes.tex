...
\subsection{Free Radical Substitution of Alkanes}
	...
	\subsubsection{Mechanism of Reaction}
		...
		for any alkane, and a sufficiently reactive halogen (Usually either \ch{\chlorine} or \ch{Br}).
		...
		\subsubtext{\vspace{10mm}\vbox{\textit{Stage II}\tabto{25mm}Propagation}}
			...
			\diagram{
				\schemestart[0, 1.0, thick]
					\chemfig{\ch{\chlorine2}} \hspace{3mm} + \hspace{3mm} \chemfig{\lewis{4.,CH\sbs{3}}}
					\arrow{->}
					\chemfig{\ch{CH3\chlorine}} \hspace{3mm} + \hspace{3mm} \chemfig{\lewis{0.,\chlorine}}
				\schemestop
			}
	...
	\subsubsection{Multi-substitution of Alkanes}
		...
		\diagram{
			\schemestart[0, 1.0, thick]
				\chemfig{\ch{CH3Cl}} \hspace{3mm} + \hspace{3mm} \chemfig{\lewis{0.,\chlorine}}
				\arrow{->}
		...
		\diagram{
			\schemestart[0, 1.0, thick]
				\chemfig{\lewis{0.,\ch{CH2\chlorine}}} \hspace{3mm} + \hspace{3mm} \chemfig{\ch{\chlorine2}}
				\arrow{->}
				\chemfig{\lewis{4.,\ch{CH2\chlorine2}}} \hspace{3mm} + \hspace{3mm} \chemfig{\lewis{0.,\chlorine}}
			\schemestop
		}
	...
	\subsubsection{Isomerism of Substituted Alkanes}
		...
		\diagram[1.0]{
			\schemestart[0, 1.0, thick]
				...
				\arrow[270]
				\chemfig{C(-[:90]H)(-[:180]H)(-[:270]H)-C(-[:90]!{Cl})(-[:270]H)-C(-[:90]H)(-[:0]H)(-[:270]H)}
			\schemestop
			...
			\schemestart[0, 1.0, thick]
				...
				\arrow[270]
				\chemfig{C(-[:90]H)(-[:180]H)(-[:270]H)-C(-[:90]H)(-[:270]H)-C(-[:0]!{Cl})(-[:90]H)(-[:270]H)}
			\schemestop
...
\subsection{Classification of Atoms with Substituents}
	...
	\begin{tabu} to \textwidth {| X[c,m] | X[c,m] | X[c,m] | X[c,m] |}
		...
		\hline
		% row one: molecules
		\molecule{C(-[:0]R1)(-[:90]H)(-[:180]H)(-[:270]H)}		\vspace{2mm}	&
		\molecule{C(-[:0]R1)(-[:90]R2)(-[:180]H)(-[:270]H)}		\vspace{2mm}	&
		\molecule{C(-[:0]R1)(-[:90]R2)(-[:180]R3)(-[:270]H)}	\vspace{2mm}	&
		\molecule{C(-[:0]R1)(-[:90]R2)(-[:180]R3)(-[:270]R4)}	\vspace{2mm}	\\
