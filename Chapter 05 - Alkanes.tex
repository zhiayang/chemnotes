...
\subsection{Classification of Atoms with Substituents}
	...
	\begin{tabu} to \textwidth {| X[c,m] | X[c,m] | X[c,m] | X[c,m] |}
		...
		\hline
		% row one: molecules
		\vspace{2mm}	\chemfig{C(-[:0]!{R1})(-[:90]H)(-[:180]H)(-[:270]H)}				\vspace{2mm}	&
		\vspace{2mm}	\chemfig{C(-[:0]!{R1})(-[:90]!{R2})(-[:180]H)(-[:270]H)}			\vspace{2mm}	&
		\vspace{2mm}	\chemfig{C(-[:0]!{R1})(-[:90]!{R2})(-[:180]!{R3})(-[:270]H)}		\vspace{2mm}	&
		\vspace{2mm}	\chemfig{C(-[:0]!{R1})(-[:90]!{R2})(-[:180]!{R3})(-[:270]!{R4})}	\vspace{2mm}	\\
