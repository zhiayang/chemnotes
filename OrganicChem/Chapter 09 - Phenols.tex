...
\part{Phenols}
	...
	\section{Structure}
		...
		\subsection{Physical Properties}
			...
			interactions, which is again due to the hydrogen bonding provided by the \ch{OH} group. This is despite the large hydrophobic
			benzene ring.
	...
	\section{Phenol Reactions}
		...
		\subsection{Acidity of Phenols}
			...
			Phenols are far more acidic than alcohols, due to the ability for the $\pi$-electron cloud of the benzene ring to delocalise the
		...
		\subsection{Reactions as an Acid}
			...
			\subsubsection{Reaction with Metals}
				In a manner similar to acids and alcohols, phenols can react with \itl{reactive} metals to form ionic salts.
		...
		\subsection{Oxidation}
			...
			Another trick --- the carbon atom attached to the \ch{OH} group has no hydrogen atom, and so phenols \itl{cannot} be
			oxidised.
		...
		\subsection{Electrophilic Substitution}
			...
			with the $\pi$-electron cloud of the benzene ring), and as such is an \itl{activating} substituent. Thus, the electron density
			in the ring is increased, and it undergoes electrophilic substitution reactions with greater ease.

			Note that the \ch{OH} group is \itl{ortho/para}, or 2,4-directing.
		...
		\subsection{Formation of Complex with \ch{Fe\Cl3}}
			...
			Phenol can form a complex with neutral \ch{Fe\Cl3 \stAq}, forming a violet complex. This reaction is mainly
		...
		\subsection{Esterification (Nucleophilic Acyl Substitution)}
			...
			The poor nucleophile character is caused by the delocalisation of the lone pair on the \ch{O} atom into the $\pi$-system. Thus,
