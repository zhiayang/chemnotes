...
\part{Isomers}
	...
	\section{Stereoisomerism}
		...
		\subsection{Cis/Trans Isomerism}
			...
			side. Note that these \itl{groups} do not necessarily have to be functional groups --- they can be as large or as simple
			as one wishes.
		...
		\subsection{Optical Isomerism}
			...
			and are distinct --- these are called \itl{enantiomers}.
