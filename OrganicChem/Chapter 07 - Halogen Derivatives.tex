...
\part{Halogen Derivatives}
	...
	\section{Halogenoalkanes (Alkyl Halides)}
		...
		\diagram[1.0]{
			\chemfig{C(-[:0]!\molR)(-[:90]!\molR)(-[:180]!\molR)(-[:270]!\molX)}
		}{The general structure of an alkyl halide.}
		...
		\subsection{Physical Properties}
			...
			The primary method of intermolecular bonding is still via \idid{} interactions, which is strengthened
			...
			This is of more significance for chloroalkanes, since \ch{\Cl} is more negative than both \ch{Br} and \ch{I}, hence creating
			...
			the halogen atom's size increases --- the \idid{} interaction plays a larger role in determining
			that.
	...
	\section{Halogenoarenes}
		...
		Halogenoarenes are simply molecules where the halogen atom is \itl{directly attached} to the benzene ring.
	...
	\section{Halogenated Molecule Formation}
		...
		\subsection{Free Radical Substitution}
			...
			\vbox{\textbf{Observations:} \tabto{35mm}\boit{\color{Mahogany}Reddish-brown} \ch{Br2} / \itl{\color{YellowGreen}yellowish-green} \ch{\Cl2} decolourises.}
			...
			However, this is usually a \itl{bad} way to prepare halogenoalkanes, due to the mix of products that will be formed, including
		...
		\subsection{Electrophilic Addition to Alkenes}
			...
			\subsubsection{Addition of \ch{X2}}
				...
				having two halogen atoms in the molecule, or a \itl{dihalide}.
		...
		\subsection{Nucleophilic Substitution of \ch{OH} groups (Chlorine)}
			...
			\subsubsection{Hydrogen Chloride (\ch{H\Cl})}
				...
				Here, a distinction must be made between \itl{primary}, \itl{secondary}, and \itl{tertiary} alcohols;
				tertiary alcohols will react fine with simply concentrated \ch{H\Cl}.

				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Concentrated \ch{H\Cl \stAq} / gaseous \ch{H\Cl}, \boit{or}
				...
				\diagram[1.0]{
					\schemestart[0,1.5,thick]
						...
						\chemfig{\ch{H2O}}
					\schemestop
				}{\ch{H\Cl} can be prepared \itl{in-situ} with \ch{Na\Cl} and \ch{H2SO4}.}


				For primary and secondary alcohols, anhydrous \ch{Zn\Cl2} catalyst must be used, and the reaction mixture
		...
		\subsection{Nucleophilic Substitution of \ch{OH} groups (Bromine)}
			...
			\subsubsection{Phosphorous Tribromide (\ch{PBr3})}
				...
				\ch{PBr3} is typically prepared \itl{in-situ} by heating red phosphorous with liquid bromine. It then proceeds to
				react with the alcohol, in a manner similar to that of \ch{P\Cl3}.

				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Liquid \ch{PBr3}, \boit{or}
				...
				\diagram[1.0]{
					\schemestart[0,1.5,thick]
						...
						\ch{2 PBr3}
					\schemestop
				}{\itl{In-situ} formation of \ch{PBr3}.}
		...
		\subsection{Nucleophilic Substitution of \ch{OH} groups (Iodine)}
			...
			\subsubsection{Phosphorous Triiodide (\ch{PI3})}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Liquid \ch{PI3}, \boit{or}
				...
				\diagram[1.0]{
					\schemestart[0,1.5,thick]
						...
						\ch{2 PI3}
					\schemestop
				}{\itl{In-situ} formation of \ch{PI3}.}
		...
		\subsection{Electrophilic Substitution of Arenes}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}Warm, anhydrous \ch{FeBr3}, \ch{\Al Br3}, or \ch{Fe} /
			...
			\vbox{\textbf{Observations:}\tabto{35mm}\boit{\color{Mahogany}Reddish-brown} \ch{Br2} /
										\boit{\color{YellowGreen}yellowish-green} \ch{\Cl2} decolourises.
	...
	\section{Halogenoalkane Reactions}
		...
		\subsection{Nucleophilic Substitution}
			...
			\subsubsection{Formation of Amines}
				...
				However, this amine turns out to be a \itl{stronger} nucleophile than \ch{NH3}, due to the electron-donating alkyl groups,
			...
			\subsubsection{Formation of Nitriles}
				...
				In this reaction, the lone pair is donated not by the nitrogen atom, but by the \itl{carbon} atom. This reaction is
				important, as it serves to increase the length of the carbon chain, forming a cyanohydrin --- a \itl{step-up}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Dilute \ch{H2SO4} or \ch{H\Cl}, heat, \boit{or}
				...
				Furthermore, it can also be reduced to form amines, either through the very strong reducing agent \ch{Li\Al H4}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}\ch{Li\Al H4} in dry ether (diethyl ether), \boit{or}
	...
	\section{Halogenoarene Reactions}
		...
		Since the halogen atom is directly bonded to the benzene ring, its p-orbitals overlap in a parallel manner to the $\pi$-system of the
		...
		\subsection{Electrophilic Substitution}
			...
			nitration would require temperatures \itl{above} \SI{50}{\celsius}. Also, it is \itl{ortho/para}, or 2,4-directing.
	...
	\section{Distinguishing Tests}
		...
		\subsection{Comparing Colour of Precipitate}
			...
			\vspace{0.75em}
			\vbox{\textbf{Observations:}\tabto{35mm}Chlorine\tabto{60mm}White precipitate of \ch{Ag\Cl}.
	...
	\section{Chlorofluorocarbons (CFCs)}
		...
		\diagram[1.0]{
			\schemestart[0,1.5,thick]
				\ch{CF3\Cl}\arrow{<=>[uv]}\ch{\Cl•}\hspace{2mm} + \hspace{2mm}\ch{•CF3}
			\schemestop
		}
		...
		\diagram[1.0]{
			\schemestart[0,1.0,thick]
				\ch{\Cl•}\hspace{2mm} + \hspace{2mm}\ch{O3}\arrow\ch{\Cl O•}\hspace{2mm} + \hspace{2mm}\ch{O2}
				\arrow(@c1.south east--.north east){0}[-90,.1]
				\ch{\Cl O•}\hspace{2mm} + \hspace{2mm}\ch{O}\arrow\ch{\Cl•}\hspace{2mm} + \hspace{2mm}\ch{O2}
			\schemestop
		}
