...
\part{Summary Tables}
	...
	\section{Nature of Substituent Groups}
		...
		be considered --- \ch{F}, \ch{O}, \ch{N}, and \ch{\chlorine}, since there are no overlapping p-orbitals.
	...
	\section{List and Uses of Reducing Agents}
		...
		The strength of the 3 common reducing agents used, \ch{Li\aluminium4}, \ch{NaBH4} and good old \ch{H2 \stG} with \ch{Ni}
		...
		\begin{tabu} to \textwidth {| X[c,m] | X[c,m] | X[c,m] | X[c,m] |}
			...
			\hline
						Group						&	\ch{Li\aluminium4}	&	\ch{NaBH4}	&	\ch{H2}, \ch{Pt} catalyst	\\	\hline
