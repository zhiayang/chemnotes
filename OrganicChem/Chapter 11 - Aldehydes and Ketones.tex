...
\part{Aldehydes and Ketones}
	...
	\section{Physical Properties}
		...
		and non-polar solvents, like \ch{C\chlorine4}. Their solubility in the former is due to their ability to form favourable
	...
	\section{Aldehyde and Ketone Reactions}
		...
		\subsection{Nucleophilic Addition}
			...
			\subsubsection{Formation of Nitriles (Cyanohydrins)}
				...
				Since \ch{HCN} is a toxic gas, it is typically generated \textit{in-situ} by reacting \ch{KCN} with dilute \ch{H2SO4}.
		...
		\subsection{Condensation}
			...
			\subsubsection{Distinguishing test with 2,4-DNPH}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}2,4-DNPH, room temperature.}	% \vspace{0.5em}
