...
\part{Alkanes}
	...
	\section{Classification of Carbons}
		...
		The table (ew) above gives a visual representation. \itl{R} represents an alkyl group substituent. This principle
	...
	\section{Alkane Reactions}
		\subsection{Free Radical Substitution}
			...
			\subsubsection{Mechanism of Reaction}
				...
				\paragraph{\itl{Stage I.\protect\hphantom{II}}\hspace{5mm} Initiation}
				...
				\paragraph{\itl{Stage II.\protect\hphantom{I}}\hspace{5mm} Propagation}
					...
					\diagram{
						\schemestart[0, 1.0, thick]
							\chemfig{\lewis{0.,\Cl}} \hspace{2mm} + \hspace{2mm} \chemfig{CH\sbs{4}}
							\arrow
							\chemfig{\lewis{4.,CH\sbs{3}}} \hspace{2mm} + \hspace{2mm} \chemfig{H\Cl}
							\arrow(@c1.south east--.north east){0}[-90,.1]
							\chemfig{\ch{\Cl2}} \hspace{2mm} + \hspace{2mm} \chemfig{\lewis{4.,CH\sbs{3}}}
							\arrow
							\chemfig{\ch{CH3\Cl}} \hspace{2mm} + \hspace{2mm} \chemfig{\lewis{0.,\Cl}}
						\schemestop
					}
				...
				\paragraph{\itl{Stage III.}\hspace{5mm} Termination}
					...
					\diagram{
						\schemestart[0, 1.0, thick]
							...
							\chemfig{\lewis{0.,\Cl}} \hspace{2mm} + \hspace{2mm} \chemfig{\lewis{4.,CH\sbs{3}}}
							\arrow
							\chemfig{\ch{CH3\Cl}}
						\schemestop
					}
			...
			\subsubsection{Multi-substitution}
				...
				termination stage can still react with it, forming a \ch{CH2\Cl} radical, which can continue to react.

				\diagram{
					\schemestart[0, 1.0, thick]
						\chemfig{\ch{CH3Cl}} \hspace{2mm} + \hspace{2mm} \chemfig{\lewis{0.,\Cl}}
						\arrow
						\chemfig{\lewis{4.,\ch{CH2\Cl}}}
						\arrow(@c1.south east--.north east){0}[-90,.1]
						\chemfig{\lewis{0.,\ch{CH2\Cl}}} \hspace{2mm} + \hspace{2mm} \chemfig{\ch{\Cl2}}
						\arrow
						\chemfig{\lewis{4.,\ch{CH2\Cl2}}} \hspace{2mm} + \hspace{2mm} \chemfig{\lewis{0.,\Cl}}
					\schemestop
				}

				Indeed, this can continue \itl{ad-infinitum}, so until all the hydrogen atoms on the alkane have been substituted.
			...
			\subsubsection{Halogen Reactivity}
				...
				\vspace{1em}
				\vbox{∆H\sbs{1} = BE(\ch{C–H}) - BE(\ch{H–X})		\tabto{60mm}\ch{CH3}–H + X•		\tabto{85mm} \ch{->} •\ch{CH3} + H–X	}
				\vbox{∆H\sbs{2} = BE(\ch{X–X}) - BE(\ch{C–X})		\tabto{60mm}•\ch{CH3} + X–X		\tabto{85mm} \ch{->} \ch{CH3}–X + X•	}
				\vbox{∆H\sbs{r} = ∆H\sbs{1} + ∆H\sbs{2}	\tabto{60mm}\ch{CH4} + \ch{X2}	\tabto{85mm} \ch{->} \ch{CH3X} + HX	}
				...
				\begin{tabu} to \textwidth {X[c,m] | X[c,m] | X[c,m] | X[c,m] | X[c,m]}
					...
					&\ch{H-X} / \si{\kJmol}	&\ch{H-X} / \si{\kJmol}	&\ch{H-X} / \si{\kJmol}	&$∆H_{r}$ / \si{\kJmol}\\ \hline
				...
				% \vspace{1.0em}
				% \vbox{
				% 	\ch{\Cl2}	\tabto{25mm}	H–\ch{\Cl}				\tabto{50mm} = \SI{431}{\kilo\joule\per\mole}
				% 					\tabto{25mm}	C–\ch{\Cl}				\tabto{50mm} = \SI{340}{\kilo\joule\per\mole}
				% 					\tabto{25mm}	\ch{\Cl}–\ch{\Cl2}	\tabto{50mm} = \SI{244}{\kilo\joule\per\mole}
