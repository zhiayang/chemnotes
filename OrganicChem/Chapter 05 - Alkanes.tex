...
\part{Alkanes}
	...
	\section{Alkane Reactions}
		...
		\subsubsection{Mechanism of Reaction}
			...
			\subsubtext{\vbox{\textit{Stage I}\tabto{25mm}Initiation}}
			...
			\subsubtext{\vbox{\textit{Stage II}\tabto{25mm}Propagation}}
			...
			\pagebreak
			\subsubtext{\vbox{\textit{Stage II}\tabto{25mm}Termination}}
