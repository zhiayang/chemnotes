...
\part{Alcohols}
	...
	\section{Alcohol Formation}
		...
		\subsection{Reduction of Aldehydes and Ketones}
			...
			\vbox{\textbf{Conditions:}	\tabto{35mm}\ch{Li\Al H4} in dry ether (diethyl ether), \boit{or}
  										\tabto{35mm}\ch{NaBH4} in methanol, \boit{or}
		...
		\subsection{Reduction of Carboxylic Acids}
			...
			This reduction requires a strong reducing agent, so only \ch{Li\Al H4} can be used. See the
		...
		\subsection{Hydrolysis of Esters}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}Dilute \ch{H2SO4}, heat under reflux, \boit{or}
	...
	\section{Alcohol Reactions}
		...
		\subsection{Acidity of Alcohols}
			...
			not present in water (water only has \ch{H} atoms bonded to the oxygen). These alkyl groups \itl{intensify} the negative
			...
			\subsubsection{Effect of Substituents}
				...
				Electron withdrawing groups will \itl{disperse} the negative charge on the alkoxide anion, thus resulting in a higher
				likelihood for the \ch{H+} ion to dissociate, meaning a higher acidity (and thus higher \Ka). Conversely, electron-donating
				groups (basically alkyl groups) \itl{intensify} the negative charge, destabilising the anion and decreasing acidity.
		...
		\subsection{Reactions as an Acid}
			...
			\subsubsection{Reaction with Metals}
				In a manner similar to acids, alcohols can react with \itl{reactive} metals to form ionic salts. However, these reactions
		...
		\subsection{Esterification (Nucleophilic Acyl Substitution)}
			...
			\subsubsection{With Carboxylic Acids}
				...
				These are condensation reactions, since \ch{H2O} or \ch{H\Cl} is removed and the carbon chains joined.
		...
		\subsection{Dehydration (Elimination of Water)}
			...
			Alcohols can undergo dehydration, where an \ch{OH} group combines with the \ch{H} atom on a \itl{neighbouring} carbon, forming
		...
		\subsection{Oxidation of Primary Alcohols}
			...
			\subsubsection{Controlled Oxidation to Aldehydes}
				...
				The \itl{controlled} part of this reaction lies in the immediate distillation of the aldehyde that is formed, using
				...
				Note that, in this case, the \itl{only} suitable oxidising agent is \ch{Cr2O7^2-}, as the alternative, \ch{MnO4-}, is
			...
			\subsubsection{Complete Oxidation to Carboxylic Acids}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}\ch{K2Cr2O7} with dilute \ch{H2SO4}, \boit{or} \ch{KMnO4} with dilute \ch{H2SO4},
											\tabto{35mm}heat under reflux.}
				\vspace{0.75em}
				\vbox{\textbf{Observations:}\tabto{35mm}\boit{\color{BurntOrange}Orange} \ch{Cr2O7^2-}, turns \boit{\color{LimeGreen}green}
														(\ch{Cr^3+} formed), \boit{or}
				...
				Note that, with \ch{KMnO4}, two special carboxylic acids can be \itl{even further oxidised} to give \ch{CO2} and \ch{H2O};
