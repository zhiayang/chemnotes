...
\hypertarget{ChapterAlcohols}{}
	...
	\section{Phenols}
		...
		from normal alcohols, and are covered in the \hyperlink{Chapter_Phenols}{\boit{following chapter}}.
	...
	\section{Alcohol Reactions}
		...
		\subsection{Acidity of Alcohols}
			...
			\subsubsection{Effect of Substituents}
				...
				In a manner somewhat similar to arenes, substituents along the alcohol's carbon chain can have an effect on its acidity.
				Of course, groups closer to the \ch{OH} itself (better yet, attached to the same carbon atom) have a greater effect. Note
				...
				attached to the alcohol is sp\sps{3} hybridised. Refer to \hyperlink{CaveatResonanceTable}{\boit{this explanation}} for an
				elaboration.
		...
		\subsection{Oxidation of Primary Alcohols}
			...
			\subsubsection{Controlled Oxidation to Aldehydes}
				...
				\vspace{0.5em}
				\vbox{\textbf{Observations:}\tabto{35mm}\textit{\color{BurntOrange}Orange} \ch{Cr2O7^2-}, turns \textit{\color{LimeGreen}green}
														(\ch{Cr^3+} formed).}
			...
			\subsubsection{Complete Oxidation to Carboxylic Acids}
				...
				\vbox{\textbf{Observations:}\tabto{35mm}\textit{\color{BurntOrange}Orange} \ch{Cr2O7^2-}, turns \textit{\color{LimeGreen}green}
											...
											\tabto{35mm}\textit{\color{Plum}Purple} \ch{MnO4-} decolourises (\ch{Mn^2+} formed)}
		...
		\subsection{Tri-iodomethane (Iodoform) Formation}
			...
			\vbox{\textbf{Observations:}\tabto{35mm}\textit{\color{Dandelion}Yellow} precipitate of \ch{CHI3} is formed.}

			\diagram[1.0]{
				\schemestart[0,2.0,thick]
					\chemfig{C(-[:90]H)(-[:270]!\molMe)(-[:180]!\molR)(-[:0]!\molOH)}
					\arrow{->[\ch{I2 \stAq}, \ch{NaOH \stAq}][warm]}
					\chemfig{C(-[:180]!\molR)(=[:45]!\molO)(-[:315]!\molO\mch Na\pch)}
				\schemestop
