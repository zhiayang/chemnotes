...
\part{Alkenes}
	...
	\section{Creation of Alkenes}
		...
		\subsection{Dehydration (Elimination of Water)}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}Excess concentrated \ch{H2SO4}, \SI{170}{\celsius}, \itl{OR}
	...
	\subsection{Electrophilic Addition}
		...
		During a reaction, the comparatively weaker $\pi$-bond is preferentially broken over the stronger $\sigma$-bond; only a
		\ch{C-C} bond remains, and atoms are \itl{added} to the carbons, since they are now able to form an additional
		bond each. Hence, electrophilic \itl{addition}.

		The detailed mechanisms for each type of electrophilic addition, which are \itl{required knowledge}, can be found
		...
		\subsubsection{Electrophilic Addition of Halogens}
			...
			\ch{I2} is too \itl{unreactive}. The reaction mechanism involves the formation of a \itl{cyclic halonium ion}
	...
	\subsection{Mild Oxidation}
		...
		Alkenes can be mildly oxidised with potassium manganate (VII), KMnO4, forming \itl{diols}. This requires a cold environment,
