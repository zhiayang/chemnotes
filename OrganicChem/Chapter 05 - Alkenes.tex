...
\part{Alkenes}
	...
	\section{Open Chain}
		...
		Alkenes are simply unsaturated hydrocarbons, with one or more double bonds. They have a general formula of
		\ch{C_nH_{2n}}.
	...
	\section{Physical Properties}
		...
		same trends as alkanes. Larger molecules have higher melting and boiling points, and higher densities; alkenes are
	...
	\section{Stability of Carbocations}
		...
		Before the reactions and mechanisms of alkenes can be discussed, it is important to note the rules governing the formation
		...
		of the most stable molecules; ions and radicals are inherently unstable.

		\subsection{Structure}

			One of the important intermediate products are carbocations, which are alkyl groups with an \sptwo{} hybridised
			central carbon atom, carrying a positive charge on that atom.
		...
		\subsection{Stability}
			...
			Conversely, electron-withdrawing species such as halogens (\ch{F}, \ch{\Cl} etc.) would further destabilise
			the carbocation, and as such products that involve the formation of these intermediates would constitute a much
			lower proportion of the end products.

		% end subsection

	\pagebreak
	\section{Alkenes Formation}
		...
		molecule is \itl{eliminated} along an alkane, and a double bond formed in its place.

		For brevity, only the conditions and overall reaction will be covered --- the reaction mechanisms can be found in the appendix.
		...
		\subsection{Dehydration (Elimination of Water)}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}Excess concentrated \ch{H2SO4}, \SI{170}{\celsius}, \boit{or}
	...
	\subsection{Electrophilic Addition}
		...
		The primary reaction mechanism of alkenes is electrophilic addition. Due to the high electron density of the $\pi$-bonds,
		electrophiles are readily attracted --- thus alkenes are far more reactive than alkanes.

		During a reaction, the comparatively weaker $\pi$-bond is preferentially broken over the stronger $\sigma$-bond, leaving a
		\ch{C-C} single bond. These carbons can thus form new bonds with other atoms, leading to an electrophilic \itl{addition}.

		The detailed mechanisms for each type of electrophilic addition can be found in
		\hyperlink{AppendixElectrophilicAddition}{\boit{the appendix}}.
		...
		\subsubsection{Markovnikov's Rule}
			...
			such as hydrogen halides. It does not apply to symmetrical reactants like \ch{\Cl2} or \ch{Br2}.

			The rule essentially states that when a hydrogen compound with the general form \ch{H-X} is added to an
			alkene that is asymmetrical about the double-bond, the hydrogen atom will be added to the carbon with \itl{more}
			existing hydrogen atoms.

			Phrased differently, the nucleophile will attack the carbon with the most stabilising (electron-donating) groups.
		...
		\subsubsection{Electrophilic Addition of Halogens}
			...
			The electrophilic addition of a halogen to an alkene does not involve Markovnikov's rule, since \ch{X2} is symmetrical.
			As the non-polar halogen molecule approaches the electron-rich $\pi$-bond, it is polarised, forming \deltap{} and \deltam{} partial
			charges.

			Note that the halogens used are usually either \ch{Br2} or \ch{\Cl2}, since \ch{F2} is too reactive and
			\ch{I2} is too unreactive. The reaction mechanism involves the formation of a \itl{cyclic halonium ion}
		...
		\subsubsection{Electrophilic Addition of Aqueous \ch{Br2}}
			...
			The mechanics of this reaction are basically the same as that of gaseous \ch{Br2}. The conditions and observations are
			fairly similar as well, except for the colour change --- aqueous \ch{Br2} is \boit{\color{Dandelion}yellow}, not reddish-brown.

			Also, since lone pair in \ch{H2O} is a stronger nucleophile than \ch{Br} and it is present in much higher concentrations,
			most of the intermediate molecules will be attacked by water instead.

			Markovnikov's Rule applies --- the \ch{OH} group will preferentially attack the carbon that has more stabilising alkyl groups.
			...
			}[Both products are formed, except 1,2-dibromoethane is the minor product.]
		...
		\subsubsection{Electrophilic Addition of Steam (Hydration)}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}\SI{300}{\celsius}, at \SI{70}{atm}, \ch{H3PO4} catalyst, \boit{or}
	...
	\subsection{Reduction (Hydrogenation)}
		...
		Note that although hydrogen atoms are added across the double bond, this is \itl{not} an electrophilic addition reaction; it
	...
	\subsection{Mild Oxidation}
		...
		Alkenes can be mildly oxidised with potassium manganate (VII), \ch{KMnO4}, forming \itl{diols}. This requires a cold environment,
		...
		agent, \ch{MnO4-}, is reduced, forming \ch{Mn^2+}.

		\vspace{1.5em}
		\vbox{\textbf{Conditions:}	\tabto{35mm}Cold \ch{KMnO4}, dilute acid (\ch{H2SO4}).}
	...
	\subsection{Strong Oxidation (Oxidative Cleavage)}
		...
		When the \ch{KMnO4} solution containing an alkene is heated, \itl{strong oxidation} will take place. The double bond is
		\itl{cleaved} instead of added to, and each side of the double bond forms its own fragment. In the case of cycloalkenes
		...
		depends \itl{only} on the temperature of the reacting solution. Only heated solutions will result in oxidative cleavage.
		...
		\begin{table}[htb]\renewcommand{\arraystretch}{1.4}\begin{center}
		\begin{tabu} to 0.9\textwidth { X[c,m] | X[c,m] | X[c,m] }

			Substituents    &   Structure   &   Product     \\ \hline
				0
							&   \vspace{2mm}\chemfig{C(-[:135]H)(-[:225]H)=[:0]}\vspace{2mm}
				...
				2
							...
							&   \vspace{2mm}\chemfig{C(-[:135]!\molR)(-[:225]!\molR)=[:0]!\molO}\vspace{2mm}    \\
