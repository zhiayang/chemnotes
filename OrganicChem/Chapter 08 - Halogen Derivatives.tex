...
\part{Halogen Derivatives}
	...
	\section{Creation of Halogenated Molecules}
		...
		\pagebreak
		\subsection{Substitution of \ch{OH} groups (Chloroalkanes)}
			...
			\subsubsection{Thionyl Chloride (\ch{SO\chlorine2})}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}\tabto{35mm}Warm, liquid \ch{SO\chlorine2}.}\vspace{0.5em}
				\vbox{\textbf{Observations:}\tabto{35mm}Formation of colourless, pungent \ch{SO2} gas, and
			...
			\subsubsection{Hydrogen Chloride (\ch{H\chlorine})}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Concentrated \ch{H\chlorine \aq} / gaseous \ch{H\chlorine} \textit{OR}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Concentrated \ch{H\chlorine \aq} / gaseous \ch{H\chlorine}.
		...
		\pagebreak
		\subsection{Substitution of \ch{OH} groups (Bromoalkanes)}
		...
		\pagebreak
		\subsection{Substitution of \ch{OH} groups (Iodoalkanes)}
		...
		\subsection{Electrophilic Substitution of Arenes}
			...
			\vbox{\textbf{Observations:}\tabto{35mm}\textit{\color{Mahogany}Reddish-brown} \ch{Br2} /
										\textit{\color{YellowGreen}yellowish-green} \ch{\chlorine2} decolourises.
	...
	\section{Halogenoalkane Reactions}
		...
		\subsection{Nucleophilic Substitution}
			...
			\subsubsection{Formation of Nitriles}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}\tabto{35mm}Dilute \ch{H2SO4}, heat.}

				\diagram[1.0]{
					\schemestart[0,1.5,thick]
						\chemfig{!\molR-[:0]C~[:0]!\molN}
						\arrow{->[dilute \ch{H2SO4}][heat]}
				...
				\vbox{\textbf{Conditions:}	\tabto{35mm}\ch{Li\aluminium H4} in dry ether (diethyl ether), \textit{OR}
											...
											\tabto{35mm}\ch{H2 \gas}, \ch{Ni} catalyst, high temperature and pressure.}
	...
	\section{Distinguishing Tests}
		...
		\subsection{Comparing Colour of Precipitate}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}Aqueous \ch{NaOH} or \ch{KOH}, dilute \ch{HNO3}, aqueous \ch{AgNO3}.}\vspace{0.5em}
