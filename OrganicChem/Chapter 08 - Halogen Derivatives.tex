...
\part{Halogen Derivatives}
	...
	\section{Creation of Halogenated Molecules}
		...
		\subsection{Free Radical Substitution}
			...
			\vbox{\textbf{Observations:} \tabto{35mm}\boit{\color{Mahogany}Reddish-brown} \ch{Br2} / \textit{\color{YellowGreen}yellowish-green} \ch{\Cl2} decolourises.}
	...
	\section{Halogenoalkane Reactions}
		...
		\subsection{Nucleophilic Substitution}
			...
			\subsubsection{Formation of Amines}
				...
				However, this amine turns out to be a \textit{stronger} nucleophile than \ch{NH3}, due to the electron-donating alkyl groups,
			...
			\subsubsection{Formation of Nitriles}
				...
				\vspace{1.5em}
				\vbox{\textbf{Conditions:}	\tabto{35mm}Dilute \ch{H2SO4} or \ch{H\Cl}, heat, \textit{OR}
