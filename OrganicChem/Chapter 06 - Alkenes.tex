...
\part{Alkenes}
	...
	\subsection{Electrophilic Addition}
		...
		in the relevant \hyperlink{AddendumElectrophilicAddition}{\boit{addendum}}.
		...
		\subsubsection{Markovnikov's Rule}
			...
			A detailed illustration of the rule can be found in the \hyperlink{AddendumMarkovnikovsRuleIllustration}{\boit{addendum}}.
