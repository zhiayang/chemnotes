...
\part{Arenes}
	...
	\section{Benzene}
		...
		\imgdiagram{110mm}{../figures/organic/ch07/benzene_delocalisation.png}
		...
		The carbon atoms are bonded to each other through $\pi$-bonds with their unhybridised p-orbitals, while the bonds with the hydrogen
		atoms (or other substituents if substituted) are done with the \sptwo orbitals.

		Furthermore, the 6 $\pi$-bond electrons are delocalised, and move freely within the ring. This increases the stability of the benzene
	...
	\section{Substituted Benzenes}
		...
		electron-rich $\pi$-system of the benzene ring. As mentioned in Chapter 4 on Induction and Resonance, certain groups and atoms
		...
		\subsection{Effect of Reactivity}
			...
			the electron density of the $\pi$-system, making it a more appealing target for electrophiles. Thus, the ring is said to
			...
			Importantly, it \itl{must be noted} that for the nitration of benzene, when the benzene ring is \itl{activated}, the
			required temperature for reaction is only \boit{\SI{30}{\celsius}}, whereas for \itl{deactivated} rings, the required
		...
		\subsection{Effect on Positions of Further Substituents}
			...
			Since the main way substituents affect the benzene ring is through the distortion of its $\pi$-system electrons, naturally
			...
			$\pi$-electron cloud of the benzene, thus allowing for the electron density to be added to the benzene ring.
			...
			\subsection{Directing Mechanism}
				...
				of the substituted ring. Technically, the 2, 3, and 4 positions are called \itl{ortho}, \itl{meta}, and \itl{para}
				...
				structure of the $\pi$-system below, there will be three points with a partial positive charge (\deltap). Since the
				substitution requires the attack of an \itl{electrophile}, these positions are \itl{less favourable}. Hence, the
			...
			\itl{high electron density} (actually the same 3 positions), which \itl{attracts} electrophiles, and as such favours
	...
	\section{Arene Reactions}
		...
		\subsection{Halogenation of Benzene}
			...
			Halogenation of benzene requires rather specific conditions, such as anhydrous \ch{FeBr3} or \ch{Fe\Cl2} (for a reaction
			with bromine and chlorine respectively), and a warm environment.

			Aluminium-based analogues of these catalysts (\ch{\Al Br3}, \ch{\Al\Cl3}) can also be used, as can pure
			filings of the metal, in which case the catalyst will be generated \itl{in-situ} (\ch{2 Fe \stS} + \ch{3 Br2 \stL} -> \ch{2 FeBr3}).
		...
		\subsection{Alkylbenzene Reactions}
			...
			\subsubsection{Halogenation}
				...
				The conditions here are basically the same as that for normal benzene.
			...
			\subsubsection{Nitration}
				...
				is lower, due to the activating effect of the \ch{CH3} substituent.
