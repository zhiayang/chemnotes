...
\part{Carboxylic Acids}
	...
	\section{Creation of Carboxylic Acids}
		...
		\subsection{Side-chain Oxidation of Alkylbenzenes}
			...
			\vspace{0.75em}
			\vbox{\textbf{Observations:}\tabto{35mm}\boit{\color{Plum}Purple} \ch{KMnO4} decolourises (\textit{acid}), or
		...
		\subsection{Oxidative Cleavage of Alkenes}
			...
			\vspace{1.5em}
			\vbox{\textbf{Conditions:}	\tabto{35mm}\ch{KMnO4}, dilute \ch{H2SO4}, heat.}	% \vspace{0.5em}
		...
		\subsection{Hydrolysis of Acyl Chlorides}
			...
			Acyl chlorides, which are a derivative of carboxylic acids where the \ch{OH} group is replaced by a \ch{\chlorine} atom, can
			be hydrolysed to form a carboxylic acid, and \ch{H\chlorine}.
	...
	\section{Carboxylic Acid Reactions}
		...
		\subsection{Acidity of Carboxylic Acids}
			...
			\subsubsection{Effect of Substituents}
				...
				Electronegative groups and atoms, such as \ch{\chlorine} or \ch{-NO2}, pull electron density away from the carboxyl carbon,
		...
		\subsection{Nucleophilic Acyl Substitution}
			...
			\subsubsection{Formation of Acyl Chlorides}
				...
				The carboxyl carbon undergoes a nucleophilic substitution, replacing the \ch{OH} group with a \ch{\chlorine} group, forming
				an acyl chloride.

				Similar to alcohols, either \ch{P\chlorine5}, \ch{P\chlorine3}, or \ch{SO\chlorine2} can be used. However, \ch{H\chlorine} will
			...
			\subsubsection{Esterification}
				...
				Note that this is \textit{not} the preferred method of creating esters, due to the need for heating and catalysis, and the fact
		...
		\subsection{Reduction}
			...
			\ch{Li\aluminium H4} can be used. See the \hyperlink{AppendixReducingAgents}{\boit{appendix}} for a list of reducing agents
		...
		\subsection{Oxidation}
			...
			With the strong oxidising agent \ch{KMnO4}, two special carboxylic acids can be \textit{even further oxidised} to give \ch{CO2}
