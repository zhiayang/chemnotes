...
\begin{center}
	...
	\vfill
	{
		...
		\itl{git}: \texttt{e4ff492f05ab7c31e6278dbe0845570d7f46e7f2}
		\normalsize
	}
	\vspace*{20mm}
...
% \input{"Chapter 01 - Functional Groups"}        %* done
% \input{"Chapter 02 - Isomers"}                  %* done
% \input{"Chapter 03 - Bonding and Electrons"}    %* done
% \input{"Chapter 04 - Alkanes"}                  %* done
% \input{"Chapter 05 - Alkenes"}                  %* done
% \input{"Chapter 06 - Arenes"}                   %* done
% \input{"Chapter 07 - Halogen Derivatives"}
% \input{"Chapter 08 - Alcohols"}
% \input{"Chapter 09 - Phenols"}
% \input{"Chapter 10 - Aldehydes and Ketones"}
% \input{"Chapter 11 - Carboxylic Acids"}
% \input{"Chapter 12 - Acyl Chlorides"}
% \input{"Chapter 13 - Esters"}
% \input{"Chapter 14 - Amides"}
% \input{"Chapter 15 - Amines"}
% \input{"Chapter 16 - Amino Acids"}
% \input{"Chapter 17 - Proteins"}
