...
\part{Acid-Base Equilibrium}
	...
	\section{Theory of Acids and Bases}
		...
		\subsection{Strength of Acids and Bases}
			...
			\subsubsection{Strong Acids and Bases}
				...
				acid or base is one that ionises \textit{completely} in solution to give \ch{H+} or \ch{OH-} respectively.
			...
			\subsubsection{Weak Acids and Bases}
				...
				Weak acids and bases, on the other hand, only dissociate \textit{partially} in water to give \ch{H+} and \ch{OH-}. Thus, they
	...
	\section{\MpH{}, \MpOH{} and Other Such Constants}
		...
		\subsection{Ionic Product of Water, \MKw{}}
			...
			Pure water actually \textit{auto-ionises} to a very slight degree, giving \ch{H+ \stAq} and \ch{OH- \stAq}.
	...
	\section{Dissociation of Acids and Bases}
		...
		\subsection{Degree of Dissociation, \chemalpha}
			...
			The degree of dissociation of a given acid or base is the \textit{ratio} of the number of moles of the substance that are ionised, to
		...
		\subsection{Calculations involving \MKa{} and \MKb{}}
			...
			to find the concentration of \ch{H+} and hence \pH{}, \textit{assuming}:
			...
			The first assumption will be \textit{invalid} when there are \textit{external sources} of \ch{H+} or \ch{A-}, as in a buffer
	...
	\section{Salt Hydrolysis}
		...
		\subsection{Weak Acid, Strong Base}
			...
			Since \ch{OH-} is present, the solution would be \textit{alkaline}. However, \ch{CH3CO2-} is still an objectively weak base
		...
		\subsection{Strong Acid, Weak Base}
			...
			forming \ch{H3O+} and giving an \textit{acidic} solution.
		...
		\subsection{Metal Cation With High Charge Density}
			...
			in the \textit{Chemistry of Transition Metals}, these ions can form complexes with \ch{H2O} ligands in aqueous solution.
	...
	\section{Buffer Solutions}
		...
		\subsection{Overview}
			...
			buffer solution to react with small amounts of \textit{both} \ch{H+} and \ch{OH-} that are added. This allows for the system
		...
		\subsection{Method of Operation}
			...
			\subsubsection{Reaction with \ch{H+}}
				...
				When a small amount of \ch{H+} ions are added to the buffer solution, they react with the \textit{large reservoir} of
				...
				to the large reservoir, the change is small, and so [\ch{H+}] remains \textit{relatively constant}, and hence so does \pH{}.
			...
			\subsubsection{Reaction with \ch{OH-}}
				...
				Note that the \textit{action reactions} of the buffer system are written with a single-directional arrow, as it is not
		...
		\subsection{\MpH{} of Buffer Solutions}
			...
			Since the dissociation of the weak acid or base is \textit{not} the only source of \ch{H+} or \ch{OH-} ions in the solution,
		...
		\subsection{Effective Buffer Range}
			...
			As \ch{H+} ions are added, the capacity of the buffer is \textit{used up}, so to speak, as the ions or molecules in the buffer are
		...
		\subsection{Biological Purpose of Buffer Systems}
			...
			\txtdiagram{
				\schemestart[0,1.0,thick]
					...
					\ch{OH- \stAq}\hspace{2mm} + \hspace{2mm}\ch{H2CO3 \stAq}\arrow\ch{HCO3- \stAq}\hspace{2mm} + \hspace{2mm}\ch{H2O \stAq}
				\schemestop
			}{\vspace{-1.5em}}
	...
	\section{Titration of Weak Acids and Bases}
		...
		\subsection{Strong Acid and Strong Base}
			...
			\textit{Phenolphthalein}, \textit{methyl orange} or \textit{thymol blue} can be used as indicators. Of note is the sharp \pH{}
		...
		\subsection{Weak Acid, Strong Base}
			...
			\textit{Phenolphthalein} or \textit{thymol blue} can be used as the indicator, since their working range lie within the sharp
			\pH{} change.
		...
		\subsection{Titration of Polyprotic Acids or Bases}
			...
			\textit{phenolphthalein} for the first equivalence point at $pH = 8.5$, and \textit{methyl orange} for the second one
			at $pH = 3.5$.

			\textit{Methyl orange} should only be added to the solution after the first equivalence point is observed, if not the first
	...
	\section{\MpH{} Indicators}
		...
		\subsection{Appropriate Indicator Selection}
			...
			%| X[c,m] | X[c,m] | X[c,m] |}
				...
				Weak Acid, Weak Base		&	\textit{none}			&	\textit{none}					\\	\hline
