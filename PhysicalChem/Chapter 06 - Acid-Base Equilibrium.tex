...
\part{Acid-Base Equilibrium}
	...
	\section{Theory of Acids and Bases}
		...
		\subsection{Strength of Acids and Bases}
			...
			Note that the \itl{strength} of an acid or base is distinct from its \itl{concentration} in solution.
			...
			\subsubsection{Strong Acids and Bases}
				...
				\txtreactioneqn{
					...
					\arrow(@c1.east--.east){0}[-90,.7]
					\chemname{\ch{NaOH}}{\tinytext{strong base}}
					\arrow(.mid east--.mid west){->}
					\chemname{\ch{OH-}}{}\hspace{2mm} + \hspace{2mm}\chemname{\ch{Na+}}{\tinytext{weak conjugate acid}}
				}

				Since they ionise \itl{completely}, the reverse reaction is negligible. This is because the conjugate base \ch{\Cl-},
				in the case of \ch{H\Cl}, has a low tendency to accept protons.
			...
			\subsubsection{Weak Acids and Bases}
				...
				are in an equilibrium with their conjugate:
				...
				A mixture of the undissociated acid or base, as well as its dissociated ions, will exist in solution.
		...
		\subsection{Levelling Effect}
			...
			When an acid (for example \ch{H\Cl}) is dissolved in water, it forms the conjugate base (\ch{\Cl-}) and the hydronium ion, \ch{H3O+} (which
			can be thought of as \ch{H+ \stAq}).

			Since water already auto-ionises to form \ch{H3O+} and \ch{OH-}, any acid stronger than \ch{H3O+} will simply continue to protonate water
			past its existing equilibrium, to create a large amount of \ch{H3O+}. The reverse is true of strong bases, forming \ch{OH-}.
			...
			and a large supply of \ch{H3O+} or \ch{OH-} respectively. Thus, the overall effect is that the strength of the acid or base
			is \enquote{levelled} by the solvent it is dissolved in; with water, any strong acid simply acts like a solution of \ch{H3O+ \stAq},
			and any strong base as \ch{OH- \stAq}.

			\subsubsection{Discrimination Window}

				From the above, it should be implied that different solvents have different \enquote{limits}; for water they are \ch{H3O+} and \ch{OH-},
				for ammonia they are \ch{NH4+} and \ch{NH2-}, and so on.

				Thus, each solvent has a \itl{discrimination window} --- acids or bases with strengths inside this window will exhibit different
				strengths, while those outside of it will be limited or \itl{levelled}, and behave like the threshold species.

				\imgdiagram{90mm}{../figures/physical/ch06/discrimination_window.jpg}{The discrimination windows of common solvents.}

				Since \ch{NH4+} is a weaker acid than \ch{H3O+}, almost all conventional strong acids will behave like a solution of \ch{NH4+} when
				dissolved in \ch{NH3}. The primary purpose of using ammonia as a solvent is to experiment with strong bases --- since \ch{NH2-} is a
				stronger base than \ch{OH-}, the levelling threshold is higher.
		...
		\subsection{Metal Cation With High Charge Density}
			...
			\diagram[0.75]{
				\schemestart[0,1.5,thick]
					\chemfig{\Al(-[:20,2.2,1]@{o1}\chemabove{{\color{Red}O}}{\smdeltam}?[a,,dashed]?[d,,dashed](-[:60,1.25]\chemabove{H}{\smdeltap})(-[@{b1}:330,1.25]@{h1}\chemabove{H}{\smdeltap}(-[:270,1.5,,,draw=none]@{o2}\chembelow{\lewis{2:,{\color{Red}O}}}{\smdeltam}(-[:210]\chemabove{H}{\smdeltap})(-[:330]\chemabove{H}{\smdeltap}))))(-[:90,1.75]H\sbs{2}O)(-[:152.5,1.6]H\sbs{2}O?[a,,dashed]?[b,,dashed])(-[:200,2.2]H\sbs{2}O?[b,,dashed]?[c,,dashed])(-[:270,1.75]H\sbs{2}O)(-[:332.5,1.6,1]O?[c,,dashed]?[d,,dashed]|H\sbs{2})}
					\arrow
					\chemfig{\Al(-[:20,2.2,1]\lewis{2:,\color{Red}O}?[a,,dashed]?[d,,dashed]H\mch)(-[:90,1.75]H\sbs{2}O)(-[:152.5,1.6]H\sbs{2}O?[a,,dashed]?[b,,dashed])(-[:200,2.2]H\sbs{2}O?[b,,dashed]?[c,,dashed])(-[:270,1.75]H\sbs{2}O)(-[:332.5,1.6,1]O?[c,,dashed]?[d,,dashed]|H\sbs{2})}
			...
			\begin{tabu} to 0.8\textwidth { X[c,m] | X[c,m] | X[c,m] }
				...
				\ch{Fe^3+}  &   \ch{[Fe(H2O)6]^3+}  &   ~ \num{6.3e-3}                                  \\
				\ch{Cr^3+}  &   \ch{[Cr(H2O)6]^3+}  &   ~ \num{1.6e-4}                                  \\
				\ch{\Al^3+} &   \ch{[\Al(H2O)6]^3+} &   ~ \num{1.4e-5}                                  \\
		...
		\subsection{Titration of Polyprotic Acids or Bases}
			...
			\begin{tikzpicture}
				...
				\begin{axis}[
					axis lines		= left,
					domain			= 0:40,
					xlabel			= vol.\ HCl\ added / \si{\cubic\centi\metre},
					ylabel			= \pH{},
					axis line style	= very thick,
					height			= 80mm,
					width			= 130mm,
	...
	\section{\texorpdfstring{\pH{}}{pH} Indicators}
		...
		\subsection{Appropriate Indicator Selection}
			...
			\begin{tabu} to 0.9\textwidth { X[2,c,m] | X[1.2,c,m] | X[2,c,m] }
				...
				weak acid, weak base        &   \itl{none}              &   \itl{none}                      \\
