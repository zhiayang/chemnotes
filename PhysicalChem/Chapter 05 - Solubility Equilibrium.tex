	...
	\section{Overview}
		...
		\subsection{Solubility of Common Ionic Compounds}
			...
			\begin{tabu} to 0.9\textwidth { X[c,m] | X[c,m] | X[c,m] }
				...
				\ch{NO3-}                       &   soluble     &   ---                                                         \\
				\ch{\Cl-}, \ch{Br-}, \ch{I-}    &   soluble     &   \ch{Ag+} and \ch{Pb^2+}                                     \\
				\ch{SO4^2-}                     &   soluble     &   \ch{Ag+}, \ch{Pb^2+}, \ch{Ca^2+}, \ch{Sr^2+}, \ch{Ba^2+}    \\
				\ch{CO3^2-}                     &   insoluble   &   group 1 cations and \ch{NH4+}              \\
				\ch{OH-}                        &   insoluble   &   group 1 cations                            \\
				\ch{O^2-}                       &   insoluble   &   group 1 cations                            \\
