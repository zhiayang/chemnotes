	...
	\section{Multi-step Reactions}
		...
		\subsection{Mechanisms}
			...
			\subsubsection{Rate-Determining Step is not First}
				...
				\SI{1}{\mole} of \ch{NO} and \ch{O2}, it is possible to simply substitute $[\mathrm{NO}_{3}] = [\mathrm{NO}][\mathrm{O}_{2}]$ directly.
			...
			\subsubsection{Reaction Pathway Diagram}
				...
				\graphdiagram[1.0]{
					\begin{endiagram}[scale=1.5,offset=1.5,x-label-text=reaction pathway,y-label-text=energy]
