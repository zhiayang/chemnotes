...
\part{Chemical Equilibrium}
	...
	\section{Overview}
		...
		\subsection{Graphs}
			...
			\subsubsection{Concentration-Time}
				...
				Note that the rate of reaction in either direction never reaches 0, and the gradient (remember, rate of change of concentration
				is directly proportional to rate of reaction) of both become 0 at the equilibrium.
			...
			\subsubsection{Rate-Time}
				...
				Note that the rates of reaction meet in the centre and are equal at the position of equilibrium.
	...
	\section{Equilibrium Constants}
		...
		\subsection{Equilibrium Constant \MKc{}}
			...
			\txtdiagram{
				\schemestart[0,1.0,thick]
					\ch{a A}\hspace{2mm} + \hspace{2mm}\ch{b B}
					\arrow
					\ch{c C}\hspace{2mm} + \hspace{2mm}\ch{d D}
				\schemestop
			}{\vspace{-2em}}
		...
		\subsection{Determination of Position of Equilibrium}
			...
			\begin{center}
				\begin{tikzpicture}
					...
					\addplot [no markers, very thick, green, opacity = 0.0] table {
						0 1
						10 1
					};
		...
		\subsection{Equilibrium Quotients \textit{Q\sbs{c}} and \textit{Q\sbs{p}}}
	...
	\section{Factors Affecting Equilibrium Position}
		...
		\subsection{Changes in Total (System) Pressure}
			...
			in the system --- thus moving the position of equilibrium \textit{to the right}, favouring the production of \ch{NH3}.
	...
	\section{The Process of Haber}
		...
		\subsection{Overview}
			...
			The \textit{Haber Process} is an important, industrially-used process for the manufacture of ammonia (\ch{NH3}), which is widely
			used for fertiliser.
