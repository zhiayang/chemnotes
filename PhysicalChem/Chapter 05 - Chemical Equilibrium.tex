...
\part{Chemical Equilibrium}
	...
	\section{Overview}
		...
		\itl{Le Châtelier}. Lexically, an equilibrium reaction is represented with a double-hooked arrow, \ch{>=<}, instead of a normal
		arrow, \ch{->}.
		...
		\subsection{Equilibrium Constant \texorpdfstring{\MKc{}}{Kc}}
			...
			\txtdiagram{
				\schemestart[0,1.0,thick]
					\ch{a}\hspace{0.1em}\ch{A}\hspace{2mm} + \hspace{2mm}\ch{b}\hspace{0.1em}\ch{B}
					\arrow
					\ch{c}\hspace{0.1em}\ch{C}\hspace{2mm} + \hspace{2mm}\ch{d}\hspace{0.1em}\ch{D}
				\schemestop
			}{\vspace{-2em}}
