...
\part{Solubility Equilibrium}
	...
	\section{Overview}
		...
		The solubility of any given ionic compound is largely determined by \enth{sol}, the enthalpy change of solution, which is the sum
		...
		\subsection{Solubility of Common Ionic Compounds}
			...
			in solution; the concentration of these ions is just \itl{very, very small}.
		...
		\subsection{Solubility Product, \MKsp{}}
			...
			\txtdiagram{
				\schemestart[0,1.0,thick]
					\ch{Mg(OH)2 \stS}
					\arrow{<=>}
					\ch{Mg^2+ \stAq}\hspace{2mm} + \hspace{2mm}\ch{2 OH- \stAq}
				\schemestop
			}{\vspace{-2em}}
			...
			\diagram[1.5]{
				$K_{c} = \frac{[Mg^{+}][OH^{-}]^{2}}{[Mg(OH)_{2}]}$\hspace{15mm}$K_{sp} = [Mg^{+}][OH^{-}]^{2}$
			}{\vspace{-1em}}

			Since the `concentration' of a solid, in this case \ch{Mg(OH)2}, is constant, it can be factored out, giving the equation of \Ksp{}. The units of \Ksp{} are naturally dependent on the ions and their powers on the right side, so in this case they are
	...
	\section{Factors Affecting Solubility}
		...
		\subsection{Position of Equilibrium}
			...
			\subsubsection{Common Ion Effect}
				...
				containing \itl{common ions} is added to an existing equilibrium, then the solubility of the sparingly soluble salt will decrease,
			...
			\subsubsection{Complex Formation}
				...
				If excess \ch{OH-} ions are added, however, then the soluble complex ion \ch{[\Al(OH)4]-} forms, which is soluble in water. This
