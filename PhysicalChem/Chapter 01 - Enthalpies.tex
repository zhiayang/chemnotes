	...
	\section{Enthalpy Change}
		...
		\subsection{Types of Enthalpy Change}
			...
			\subsubsection{Enthalpy Change of Neutralisation}
				...
				The enthalpy change of neutralisation is the heat evolved when \emph{1 mole} of \ch{H2O} is formed when an acid and a base are
				...
				\txtdiagram{
					\schemestart[0,1.0,thick]
						\ch{H\chlorine \stAq}\hspace{2mm} + \hspace{2mm}\ch{NaOH \stAq}
						\arrow
						\ch{H2O \stL}\hspace{2mm} + \hspace{2mm}\ch{Na\chlorine \stAq}
					\schemestop
				}{\enth{neut} = \SI{-57.1}{\kilo\joule\per\mole}}
			...
			\subsubsection{Enthalpy Change of Hydration}
				...
				\emph{infinite volume} of water, under standard conditions. \enth{hyd} is always negative, as it involves the
		...
		\subsection{Lattice Energy}
			...
			\subsubsection{Born-Haber Cycles}
				...
				\begin{numberedlist}
					...
					&	Thus, applying the \emph{Law of Hess} --- \enth{f} = \enth{fus} + \enth{vap} + First IE (\ch{Li}) + BE(\ch{F-F}) +
